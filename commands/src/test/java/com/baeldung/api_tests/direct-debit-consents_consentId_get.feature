...
Scenario: Retrieve direct debit consent with unauthorized access
...
Scenario: Retrieve direct debit consent with method not allowed
  Given path 'direct-debit-consents', '7404e99b-1a4d-4b08-b441-c327661527f0'
  And header Authorization = 'Bearer ' + karate.properties['AUTH_TOKEN']
  When method POST
  Then status 405

Scenario: Retrieve direct debit consent with not acceptable header
  Given path 'direct-debit-consents', '7404e99b-1a4d-4b08-b441-c327661527f0'
  And header Authorization = 'Bearer ' + karate.properties['AUTH_TOKEN']
