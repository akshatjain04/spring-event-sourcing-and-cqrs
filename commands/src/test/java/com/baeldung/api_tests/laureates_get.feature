...
Scenario: Get Laureates with non-existing resource resulting in Not Found
Given path '/2.1/laureates/nonexisting'
When method get
Then status 404
...
When method get
Then status 422
And match response == { code: '422', message: '#string' }
